...
function createNewCard(name, link, prepend=false) {
...
function removeCard() {
  const removeBtns = document.querySelectorAll('.element__trash-btn');
...
function createPlace(evt) {
  ...
  createNewCard(placeInputName, placeInputLink, true);
  closePlacePopup();
